...
export default function SavedCommandsMenu({ searchSlot }: SavedCommandsMenuProps) {
  const {
    defaultCommands,
    customCommands,
    allSearches,
    ...
    <>
      <div className="w-full">
        ...
        {open ? (
          <div
            className={
              'mt-2 max-h-[min(280px,45vh)] overflow-y-auto rounded-2xl border border-line/80 ' +
              'bg-surface p-4 shadow-soft scrollbar-slim'
            }
          >
