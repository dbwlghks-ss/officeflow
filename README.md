...
> Vite only exposes variables prefixed with `VITE_` to the client. The `.env` file is git-ignored; never commit real keys. Restart the dev server after changing `.env`.
